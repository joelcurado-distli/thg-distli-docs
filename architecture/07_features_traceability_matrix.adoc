...
|<<./01_introduction_and_goals/02_requirements_overview.adoc#R1, Web3 Auth>>
|<<./01_introduction_and_goals/03_quality_goals.adoc#Q2, Security>>
...
|<<./06_risks_and_tech_debt/01_risks.adoc#R2, Key Recovery>>
