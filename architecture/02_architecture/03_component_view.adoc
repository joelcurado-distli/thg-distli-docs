...
This document provides a component-level view (C3) of the Project, detailing the internal structure of the main containers and their interactions with external systems.

== [[components]] Component Diagram - Frontend

 - Behavioral Baseline Engine (787 lines)
  - Byzantine Consensus Framework
  - ZKP Settlement System
  - XGBoost ML Fallback
  - P2P Network (libp2p)
