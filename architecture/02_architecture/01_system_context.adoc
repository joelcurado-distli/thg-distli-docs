...
[NOTE]
5-party consortium with external integrations to HSS systems, public Hedera ledger, and operator APIs
== Context Diagram
// tag::architect[]
[plantuml, format=png]
----
...
=== Admin User
[NOTE]
Description of what the Admin User does, which features they use and what for. Any feature listed here should be described in the <<../07_features_traceability_matrix.adoc#ftm, features>> list
