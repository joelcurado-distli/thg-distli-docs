...
| BCE| Bilateral Call Event (roaming settlement record)
| ZKP| Zero-Knowledge Proof (privacy-preserving cryptography)
| IMSI| International Mobile Subscriber Identity
| SIM Swap| Fraudulent transfer of phone number to attacker's SIM
...
<<../01_introduction_and_goals/04_glossary.adoc#DLT, DLT>>
////
